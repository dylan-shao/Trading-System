		...
		<div id="tradingview_690a3-wrapper"
			...
			<div
				...
				<div
					...
					<a href="https://www.tradingview.com/?utmsource=www.investopedia.com&amp;utmmedium=www.investopedia.com/"
						target="_blank"
						style="color: #0099d4; text-decoration: none; font-size: 11px;"> </a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-sm-4">
				<div class="team-member">
					<img src="icon/user.png" class="img-responsive img-circle" alt="" style="width:68px;height:68px;">
					<h4>Rui Wang</h4>
